		...
		<div class="content">
			...
			<div class="section2">
				...
				<div class="section2_text">
                    <span>한옥숙박체험관 한옥1호 이야기...</span> <br>
높은 천정에 자연스럽게 비뚤어진 서까래의 모습이 아름다운 천정과 고풍스럽고 깨끗한 다락방... <br />
자연스럽게 굽어 그 멋을 더한 나무들은 오랜 세월을 담아 세월만큼 더욱더 아름다운 빛깔을 간직하게 되는 한옥전통의 모습을 볼 수 있는 멋스러운 방입니다. <br />
1호실은 온돌방에서 3인, 멋스러운 복층 다락방에도 3인이 투숙할수 있으므로 최대 6명까지 이용가능한 방입니다. <br /><br />

객실내 비치물품 : 단독화장실(샤워)비데설치와 수건, 샴프, 린스, 치약, 바디워시, 헤어드라이, 브러시빗, 모든객실 무료WI-Fi Zone <br /> 
케이블TV(nhk,cctv,cnn) 방마다 냉,온수 정수기, 고급이부자리를 제공 합니다.
