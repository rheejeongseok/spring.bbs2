...
<span class="text_new">무인카페</span> <br>
<span class="text_new">조식 이용시간 : 오전 8:00 ~ 오전 9:30</span> <br>
    작은 카페에 소박한 정성을 담아 머무는 이들에게 편안함을 제공되길 바랍니다. <br>
    한옥숙박체험관 투숙객들만 이용할수 있는 셀프카페로...
    카페는 조식서비스와 커피나 음료, 전통차등의 티서비스를 제공하기 위한 공간입니다. <br>
    아기자기한 작은 공간, 따뜻한 한옥빛깔이 담겨 더욱 예쁜 공간!
    따뜻한 차한잔과 파란하늘에 맞닿은 기와의 운치를 느껴보시기 바랍니다.
                    </div>
                </div>
