		...
		<div class="content">
            ...
            <c:if test="${user.userid == null }">
                <div class="login-form">
                        <span>회원가입</span>
                        <form method="post"  action="/bbs2/join" enctype="application/x-www-form-urlencoded">
                            <table>
                            <colgroup>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="button" class="check_id" value="아이디 중복검사"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>비밀번호</td>
                                ...
                                <tr>
                                    <td>비밀번호확인</td>
                                    <td><input type="password" name="passwordC" placeholder="비밀번호 확인"></td>
                                </tr>
                                <tr>
                                    <td>주소</td>
                                    <td>
